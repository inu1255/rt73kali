...
WFLAGS := -Wno-error=incompatible-pointer-types -Wno-error=date-time -DAGGREGATION_SUPPORT -DPIGGYBACK_SUPPORT -DWMM_SUPPORT  -DLINUX -Wall -Wstrict-prototypes -Wno-trigraphs 
